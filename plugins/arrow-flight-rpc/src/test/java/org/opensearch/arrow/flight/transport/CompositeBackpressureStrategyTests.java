...
public class CompositeBackpressureStrategyTests extends OpenSearchTestCase {
    ...
    /**
     * register(listener) must install both onReady and onCancel handlers via the parent strategy.
     * The channel's own setOnCancelHandler is intentionally NOT called by the channel anymore —
     * the strategy owns it, and the channel cleanup runs via the composed cancelCallback.
     */
