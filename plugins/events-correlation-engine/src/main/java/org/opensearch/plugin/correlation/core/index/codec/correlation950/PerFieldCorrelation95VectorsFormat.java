 ...
 */
public class PerFieldCorrelation95VectorsFormat extends BasePerFieldCorrelationVectorsFormat {

    /**
     * Parameterized ctor for PerFieldCorrelationVectorsFormat
     * @param mapperService mapper service
     */
    public PerFieldCorrelation95VectorsFormat(final Optional<MapperService> mapperService) {
        super(
            mapperService,
