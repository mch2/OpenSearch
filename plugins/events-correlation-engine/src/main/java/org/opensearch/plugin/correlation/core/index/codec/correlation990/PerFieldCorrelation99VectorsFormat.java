 ...
 */
public class PerFieldCorrelation99VectorsFormat extends BasePerFieldCorrelationVectorsFormat {

    /**
     * Parameterized ctor for PerFieldCorrelationVectorsFormat
     * @param mapperService mapper service
     */
    public PerFieldCorrelation99VectorsFormat(final Optional<MapperService> mapperService) {
        super(
            mapperService,
