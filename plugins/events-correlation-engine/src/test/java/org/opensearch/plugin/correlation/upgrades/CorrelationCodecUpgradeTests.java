...
package org.opensearch.plugin.correlation.upgrades;
...
import org.opensearch.upgrades.AbstractFullClusterRestartTestCase;
...
public class CorrelationCodecUpgradeTests extends AbstractFullClusterRestartTestCase {
    ...
    public void testCodecUpgrade() throws IOException {
        // write some segments with existing codec
