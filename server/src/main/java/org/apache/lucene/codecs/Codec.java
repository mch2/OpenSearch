...
public abstract class Codec implements NamedSPILoader.NamedSPI {
    ...
    public static final Logger logger = LogManager.getLogger(Codec.class);
    ...
    public static Codec forName(String name) {
        logger.info("Requesting codec {}", name);
        return hacks.get(name);
//        return Holder.getLoader().lookup(name);
    }

    private static Map<String, Codec> hacks = Map.of("Lucene99", new DummyCodec());
