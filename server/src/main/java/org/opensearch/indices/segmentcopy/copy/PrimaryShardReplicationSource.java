...
import static org.opensearch.indices.segmentcopy.copy.SegmentReplicationPrimaryService.Actions.GET_CHECKPOINT_INFO;
import static org.opensearch.indices.segmentcopy.copy.SegmentReplicationPrimaryService.Actions.GET_FILES;

/**
 * A ReplicationSource implementation where our source is the primary shard in a cluster.
 */
public class PrimaryShardReplicationSource implements ReplicationSource {
    ...
    private final SegmentReplicationReplicaService segmentReplicationService;
    ...
    @Override
    public String name() {
        return "Primary Segment Copy";
    }

    @Override
    public void getCheckpointInfo(long replicationId, ReplicationCheckpoint checkpoint, StepListener<CheckpointInfoResponse> listener) {
    ...
    public void getFiles(long replicationId, ReplicationCheckpoint checkpoint, List<StoreFileMetadata> filesToFetch, StepListener<GetFilesResponse> listener) {
        ...
        GetFilesRequest request = new GetFilesRequest(replicationId, getAllocationId(shardId), shardId, nodes.getLocalNode(), filesToFetch, checkpoint);
