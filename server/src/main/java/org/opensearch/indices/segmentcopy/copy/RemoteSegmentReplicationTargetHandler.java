...
public class RemoteSegmentReplicationTargetHandler implements RecoveryTargetHandler {
    ...
    public RemoteSegmentReplicationTargetHandler(
        long recoveryId,
        ShardId shardId,
    ...
    public void finalizeRecovery(final long globalCheckpoint, final long trimAboveSeqNo, final ActionListener<Void> listener) {
        final String action = SegmentReplicationTargetService.Actions.FINALIZE;
    ...
    public void receiveSegmentInfosBytes(long version, long gen, byte[] infosBytes, ActionListener<Void> listener) {
        String action = SegmentReplicationTargetService.Actions.INFOS_BYTES;
        final long requestSeqNo = requestSeqNoGenerator.getAndIncrement();
        ReceiveSegmentInfosBytesRequest request = new ReceiveSegmentInfosBytesRequest(
            recoveryId,
            requestSeqNo,
            shardId,
            gen,
    ...
    public void receiveFileInfo(
        ...
        final String action = SegmentReplicationTargetService.Actions.FILES_INFO;
        final long requestSeqNo = requestSeqNoGenerator.getAndIncrement();
    ...
    public void cleanFiles(
        ...
        final String action = SegmentReplicationTargetService.Actions.CLEAN_FILES;
        final long requestSeqNo = requestSeqNoGenerator.getAndIncrement();
    ...
    public void writeFileChunk(
        ...
        final String action = SegmentReplicationTargetService.Actions.FILE_CHUNK;
        final long requestSeqNo = requestSeqNoGenerator.getAndIncrement();
