...
public class PplClickBenchIT extends AnalyticsRestTestCase {
    ...
    // in play (the docvalues and plain variants), and still asserted on the default legacy/parquet run.
    private static final Set<Integer> SKIP_QUERIES = Set.of("docvalues", "plain")
        .contains(System.getProperty("tests.analytics.storage", "parquet")) ? Set.of(5, 9, 10) : Set.of(9, 10);
