 ...
 *   <li>{@link org.opensearch.parquet.fields.core.data.number.HalfFloatParquetField} — OpenSearch {@code half_float} widened to 32-bit Arrow Float ({@code Float4Vector})</li>
