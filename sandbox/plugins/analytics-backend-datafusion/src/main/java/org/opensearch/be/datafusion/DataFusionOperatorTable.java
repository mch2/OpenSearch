...
/**
 * Declares the aggregate functions that the DataFusion bridge can convert to Substrait.
 *
 * <p>Only aggregate functions that the bridge can actually serialize are declared here —
 * declaring more would cause false capability claims in the BackendCapabilityRegistry.
 *
 */
