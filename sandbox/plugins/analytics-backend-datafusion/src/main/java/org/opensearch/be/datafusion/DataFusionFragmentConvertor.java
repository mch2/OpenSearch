    ...
    private SubstraitRelVisitor createVisitor(RelNode relNode) {
        ...
        ConverterProvider converterProvider = new ConverterProvider(
            ...
            public List<CallConverter> getCallConverters() {
                // Struct field access is offered before signature matching — see
                // GetFieldCallConverter for why the matcher can't handle it.
                List<CallConverter> converters = new ArrayList<>();
                converters.add(new GetFieldCallConverter(extensions, typeConverter));
