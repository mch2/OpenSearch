 ...
 * @opensearch.internal
 */
public interface StageTaskRunner<T extends StageTask> {
    ...
    StageTaskRunner<StageTask> NONE = (task, listener) -> {
        throw new IllegalStateException("StageTaskRunner.NONE invoked for task " + task.id());
    };
}
