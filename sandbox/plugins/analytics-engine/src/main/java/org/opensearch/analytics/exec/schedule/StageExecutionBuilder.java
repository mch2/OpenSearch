...
import org.opensearch.analytics.exec.schedule.coordinator.LocalComputeStageExecutionFactory;
import org.opensearch.analytics.exec.schedule.coordinator.PassThroughStageExecution;
import org.opensearch.analytics.exec.schedule.coordinator.ReduceStageExecutionFactory;
import org.opensearch.analytics.exec.schedule.shard.ShardFragmentStageExecutionFactory;
...
public class StageExecutionBuilder {
     ...
     */
    public AbstractStageExecution buildRootExecution(Stage rootStage, QueryContext config) {
        // TODO: Update to read directly from back-end provided ExchangeSource when the root stage has a fragment
        AbstractStageExecution rootExec = buildStageExecution(rootStage, new RowProducingSink(), config);
     ...
     */
    public AbstractStageExecution buildExecution(Stage stage, AbstractStageExecution parentExec, QueryContext config) {
    ...
    private AbstractStageExecution buildStageExecution(Stage stage, ExchangeSink sink, QueryContext config) {
     ...
     */
    private static ExchangeSink resolveRowSink(Stage stage, AbstractStageExecution parentExec) {
