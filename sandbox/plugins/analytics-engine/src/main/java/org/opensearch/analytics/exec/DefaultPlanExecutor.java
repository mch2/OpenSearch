...
public class DefaultPlanExecutor extends HandledTransportAction<ActionRequest, ActionResponse>
    ...
    public DefaultPlanExecutor(
        ...
        this.reduceExecutor = threadPool.executor(AnalyticsPlugin.REDUCE_THREAD_POOL);
    ...
    private void executeInternal(RelNode logicalFragment, ActionListener<Iterable<Object[]>> listener) {
        ...
        try {
            context = new QueryContext(dag, searchExecutor, reduceExecutor, queryTask, queryAllocator, ownsAllocator);
        } catch (Exception e) {
