...
public class JoinRuleTests extends BasePlannerRulesTests {
    ...
    public void testInnerEquiJoinMatchesAndProducesOpenSearchJoin() {
        ...
        assertTrue("left input wrapped in OpenSearchExchangeReducer, got " + left.getClass().getSimpleName(),
            left instanceof OpenSearchExchangeReducer);
        assertTrue("right input wrapped in OpenSearchExchangeReducer, got " + right.getClass().getSimpleName(),
