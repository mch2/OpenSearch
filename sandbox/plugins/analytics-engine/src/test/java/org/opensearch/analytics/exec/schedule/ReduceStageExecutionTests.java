...
import org.opensearch.analytics.exec.schedule.coordinator.ReduceStageExecution;
...
public class ReduceStageExecutionTests extends OpenSearchTestCase {
    ...
    public void testBufferedSchedulesEagerlyIsFalse() {
        ...
        AbstractStageExecution exec = new ReduceStageExecution(stageWithId(0), mockContext(), backend, new CapturingSink());
